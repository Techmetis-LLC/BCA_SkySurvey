...
cd asteroid-detection-platform
...
docker build -t asteroid-detector .

# Run detection
docker run -v $(pwd)/images:/data asteroid-detector \
...
```bash
# Clone repository
git clone https://github.com/yourusername/asteroid-detection-platform.git
cd asteroid-detection-platform
